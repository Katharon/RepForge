# Slice 19 — Analytics charts and range selector UI

## Goal

Build analytics UI with metric selector, time-range selector, empty states, and chart cards.

## Read first

1. `AGENTS.md`
2. `docs/03-design-ux/design_system.md`
3. `docs/03-design-ux/component_catalog.md`
4. `docs/00-project/screenshot_inventory.md`
5. `docs/06-slices/slice_19_analytics_charts_range_selector_ui.md`
...
Write formula/aggregation tests first, including empty and zero previous-period cases.
...
```text
feat(analytics): add charts and range selector UI
```
...
Implement Slice 19: Analytics charts and range selector UI.
