# Slice 04 — Design tokens and app theme

## Goal

Implement the custom dark Material 3 theme, design tokens, typography helpers, and base AppCard components.
...
4. `docs/06-slices/slice_04_design_tokens_app_theme.md`
...
Add widget tests for theme/app card rendering if project is bootstrapped.
...
```text
feat(ui): add dark fitness design system foundation
```
...
Implement Slice 04: Design tokens and app theme.
