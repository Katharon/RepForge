# Slice 07 — Analytics formula domain tests

## Goal

Implement analytics formulas and 1RM calculations in pure Dart with exhaustive unit tests.
...
4. `docs/04-quality/tdd_workflow.md`
5. `docs/06-slices/slice_07_analytics_formula_domain_tests.md`
...
```text
feat(analytics): add formula and period comparison domain services
```
...
Implement Slice 07: Analytics formula domain tests.
