# Slice 38 — Remote push notification boundary
...
5. `docs/06-slices/slice_38_remote_push_notification_boundary.md`
...
Write gateway/unit tests with fake notification scheduler where possible.
...
```text
feat(notifications): add remote push boundary
```
...
Implement Slice 38: Remote push notification boundary.
