...
Add linting, formatting expectations, base test setup, and make CI-ready quality gates available locally.

## Read first

1. `AGENTS.md`
2. `docs/04-quality/code_quality.md`
3. `docs/04-quality/test_strategy.md`
4. `docs/06-slices/slice_02_analysis_options_formatting_test_gates.md`
...
```text
chore(quality): add Flutter lint and test gates
```
...
Implement Slice 02: Analysis options, formatting, test gates.
