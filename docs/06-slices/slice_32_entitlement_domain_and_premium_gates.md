# Slice 32 — Entitlement domain and premium gates

## Goal

Introduce premium entitlement model and feature-gate abstractions without store integration yet.
...
- Do not integrate real stores yet.
- Do not force login for local-only users.

## TDD requirements

Write entitlement decision tests first.
...
Use freemium gates. Do not lock local tracking, groups, base analytics, custom exercises, or export behind Premium.
