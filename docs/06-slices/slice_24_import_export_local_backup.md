# Slice 24 — Import/export local backup

## Goal

Implement JSON/CSV export and validated import for local workout data.

## Read first

1. `AGENTS.md`
2. `docs/02-architecture/migrations_import_export.md`
3. `docs/02-architecture/security_privacy_threat_model.md`
4. `docs/04-quality/test_strategy.md`
5. `docs/06-slices/slice_24_import_export_local_backup.md`
...
Write export/import validation tests first.
...
```text
feat(backup): add local import and export
```
...
Implement Slice 24: Import/export local backup.
