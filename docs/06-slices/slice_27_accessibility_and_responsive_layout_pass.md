# Slice 27 — Accessibility and responsive layout pass

## Goal

Audit and fix semantics, text scaling, touch targets, and tablet-friendly layout basics.
...
Add semantics/text-scaling widget tests first.
...
```text
feat(ui): improve accessibility and responsive layouts
```
