# Slice 33 — App-store purchase integration

## Goal

Integrate app-store purchases behind gateway abstraction with fakeable tests.
...
4. `docs/06-slices/slice_33_app_store_purchase_integration.md`
...
- Do not build a custom backend in this slice.
- Do not trust local purchase flags as final authority.

## TDD requirements

Write fake purchase gateway and entitlement update tests first.
...
Implement Slice 33: App-store purchase integration.
...
Integrate subscriptions only for Premium features. Trial copy must clearly show trial duration, renewal price, included features, restore purchases, Terms, and Privacy Policy.
