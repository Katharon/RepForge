# Slice 20 — Estimated 1RM feature

## Goal

Build 1RM settings/formula selection and 1RM chart/value display.
...
5. `docs/06-slices/slice_20_estimated_1rm_feature.md`
...
```text
feat(analytics): add estimated one-rep max feature
```
...
Implement Slice 20: Estimated 1RM feature.
