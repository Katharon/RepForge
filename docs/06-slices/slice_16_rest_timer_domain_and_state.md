# Slice 16 — Rest timer domain and state

## Goal

Implement rest timer domain/application logic and visible countdown state without platform notifications yet.
...
Write timer policy and Cubit tests using fake clock first.
