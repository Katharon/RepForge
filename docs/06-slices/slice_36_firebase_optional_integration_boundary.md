# Slice 36 — Firebase optional integration boundary
...
3. `docs/02-architecture/notifications.md`
4. `docs/07-references/research_references.md`
5. `docs/06-slices/slice_36_firebase_optional_integration_boundary.md`
...
- Do not migrate the app to Firebase-only architecture.
- Do not make local logging depend on Firebase.

## TDD requirements

Add initialization boundary tests/fakes; do not require real Firebase in unit tests.
...
```text
feat(firebase): add optional Firebase integration boundary
```
...
Implement Slice 36: Firebase optional integration boundary.
