# Slice 26 — Search, filter, sort, and archive flows

## Goal

Add search/filter/sort UX for exercises, sets, programs, and archived items.
...
```text
feat(training-log): add search filter sort and archive flows
```
...
Implement Slice 26: Search, filter, sort, and archive flows.
