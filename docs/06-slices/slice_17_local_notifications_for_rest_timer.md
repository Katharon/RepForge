# Slice 17 — Local notifications for rest timer

## Goal

Add local notification scheduling/canceling for rest timer completion, with permission flow.
...
- Do not use Firebase Cloud Messaging for local rest timers.
- Do not add remote push or account logic.
