# Slice 40 — App icon, splash, and store metadata

## Goal

Add app icon/splash assets, app metadata, privacy copy, and store listing draft docs.
...
```text
feat(release): add app branding and store metadata
```
