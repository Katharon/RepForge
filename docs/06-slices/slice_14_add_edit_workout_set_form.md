# Slice 14 — Add/edit workout set form

## Goal

Build add/edit/delete set screen with validation, date/time fields, and tests.
...
5. `docs/06-slices/slice_14_add_edit_workout_set_form.md`
...
```text
feat(training-log): implement add and edit set form
```
...
Implement Slice 14: Add/edit workout set form.
